...
>
  <head>
    ...
    <title>Dropdowns - UI elements | OneDream Dashboard</title>
                  ...
                  <div class="demo-inline-spacing">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Action</a></li>
                        <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Another action</a></li>
                        <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Something else here</a></li>
                        <li>
                          <hr class="dropdown-divider" />
                        </li>
                        <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Separated link</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                              <a href="{{ url("javascript:void(0);") }}" class="dropdown-item d-flex align-items-center"
                      ...
                      <div class="demo-inline-spacing">
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu dropdown-menu-end w-px-300">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ url("javascript:void(0)") }}">New around here? Sign up</a>
                            <a class="dropdown-item" href="{{ url("javascript:void(0)") }}">Forgot password?</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="defaultDropdown">
                            <li><a class="dropdown-item" href="{{ url("javascript:void(0)") }}">Menu item</a></li>
                            <li><a class="dropdown-item" href="{{ url("javascript:void(0)") }}">Menu item</a></li>
                            <li><a class="dropdown-item" href="{{ url("javascript:void(0)") }}">Menu item</a></li>
                          </ul>
                        </div>

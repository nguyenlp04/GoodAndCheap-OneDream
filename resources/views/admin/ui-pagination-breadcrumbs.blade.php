...
>
  <head>
    ...
    <title>Pagination and breadcrumbs - UI elements | OneDream Dashboard</title>
                        ...
                        <nav aria-label="Page navigation">
                          <ul class="pagination">
                            <li class="page-item first">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}"
                            ...
                            <li class="page-item">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}">1</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}">2</a>
                            </li>
                            <li class="page-item active">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}">3</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}">4</a>
                            </li>
                            <li class="page-item">
                              <a class="page-link" href="{{ url("javascript:void(0);") }}">5</a>
                            </li>
                ...
                <div class="card-body">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a href="{{ url("javascript:void(0);") }}">Library</a>
                      </li>

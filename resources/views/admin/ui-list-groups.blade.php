...
>
  <head>
    ...
    <title>List groups - UI elements | OneDream Dashboard</title>
                    ...
                    <div class="col-lg-6 mb-4 mb-xl-0">
                      ...
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                          <a href="{{ url("javascript:void(0);") }}" class="list-group-item list-group-item-action active"
                            >Bear claw cake biscuit</a
                          >
                          <a href="{{ url("javascript:void(0);") }}" class="list-group-item list-group-item-action"
                            >Soufflé pastry pie ice</a
                          >
                          <a href="{{ url("javascript:void(0);") }}" class="list-group-item list-group-item-action disabled"

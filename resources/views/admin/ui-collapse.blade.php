...
>
  <head>
    ...
    <title>Collapse - UI elements | OneDream Dashboard</title>
                    ...
                    <div class="card-body">
                      ...
                      <div class="collapse" id="collapseExample">
                        <div class="d-grid d-sm-flex p-3 border">
                          <img
                            src="{{ asset("/../admin/assets/img/elements/1.jpg") }}"
                            alt="collapse-image"
                            height="125"
                    ...
                    <div class="card-body">
                      ...
                      <p class="demo-inline-spacing">
                        <a
                          class="btn btn-primary me-1"
                          data-bs-toggle="collapse"
                          href="{{ url("#multiCollapseExample1") }}"
                          role="button"
                          aria-expanded="false"
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6 mb-2 mb-md-0">
                          <div class="collapse multi-collapse" id="multiCollapseExample1">
                            <div class="d-grid d-sm-flex p-3 border">
                              <img
                                src="{{ asset("/../admin/assets/img/elements/2.jpg") }}"
                                alt="collapse-image"
                                height="125"
                                class="me-4 mb-sm-0 mb-2"
                              />
                        ...
                        <div class="col-12 col-md-6">
                          <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="d-grid d-sm-flex p-3 border">
                              <img
                                src="{{ asset("/../admin/assets/img/elements/3.jpg") }}"
                                alt="collapse-image"
                                height="125"
                                class="me-4 mb-sm-0 mb-2"
                              />

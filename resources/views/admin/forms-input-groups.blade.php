...
>
  <head>
    ...
    <title>Input groups - Forms | OneDream Dashboard</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      ...
                      <div class="input-group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Action before</a></li>
                          <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Another action before</a></li>
                          <li><a class="dropdown-item" href="{{ url("javascript:void(0);") }}">Something else here</a></li>
                          <li>
                            <hr class="dropdown-divider" />
                          </li>
